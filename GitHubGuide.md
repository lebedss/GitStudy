...
* Шаг 2-ой: [клонируйте проект на свою машину](Project_Images\CloneYourProjectToPC.png)
 Перейдите в свой форк репозитория (который теперь находится в ваших репозиториях GitHub). Затем клонируйте проект на свою машину, введя в окне вашего терминала:
