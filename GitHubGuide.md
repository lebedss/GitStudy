...
В конечном счёте владелец проекта которому прислали pull request может либо принять предлагаемые изменения - кнопка: confirm merge
либо же оказать - кнопка: close pull request. Именно благодаря наличию сиcтемы коментариев отсеивается огромное количество конфликтов и багов...
